...
\\
\\
Metristen avaruuksien peruskäsitteitä, kuten joukkojen välinen etäisyys ja normin yhteys metriikkaan, esitetään kolmannessa luvussa. Samassa luvussa esitetään homeomorfismin, upotuksen ja isometrian välisiä suhteita. Kuratowskin upotuslauseen todistuksessa hyödynnettyjä rajoitettua metriikkaa koskevat lemmat \ref{rajmetri} ja \ref{rajmetri2} todistetaan.
\\
\\
%Kuratowskin upotuslauseessa merkittävässä asemassa oleva konveksi verho esitellään omassa luvussaan
Neljännessä luvussa käsitellään konveksin verhon ominaisuuksia aloittaen konveksiuden määrittelystä.
\\
\\
