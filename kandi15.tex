...
\begin{split}
 \lambda_0+\lambda_1+\cdots+ \lambda_{n}+ \lambda_{n+1}=1=&\frac{\lambda_0+\lambda_1+\cdots+ \lambda_{n}+ \lambda_{n+1}}{1}=\frac{\lambda_0+\lambda_1+\cdots+ \lambda_{n}}{1- \lambda_{n+1}}\\
 =&\frac{ \lambda_0}{1-\lambda_{n+1}} +\frac{ \lambda_1}{1-\lambda_{n+1}} +\cdots+\frac{ \lambda_n}{1-\lambda_{n+1}} .
\end{split}
\end{equation}
Tällöin kaavojen \ref{konvoletus} ja \ref{konvsumma} nojalla
\begin{equation*}
\begin{split}
\frac{ \lambda_0}{1-\lambda_{n+1}} x_0+\frac{ \lambda_1}{1-\lambda_{n+1}} x_1+\cdots+\frac{ \lambda_n}{1-\lambda_{n+1}} x_{n}\in C(A)
\end{split}
%\quad\text{missä } x_i\in A, \lambda_i\geq0\text{, ja }
%\lambda_0+\lambda_1+\cdots+ \lambda_{n} =1
%\sum_{i=0}^{n}{\lambda_i}=1
