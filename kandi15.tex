...
Tällöin joukon $A$ konveksi verho $C(A)$ on joukon $A$ vektorien muotoa $\lambda_0 x_0+\lambda_1 x_1+\cdots+\lambda_{n} x_{n}$ olevien lineaarikombinaatioiden muodostama joukko, kun $x_i\in A$, $\lambda_i\geq0$ ja $\lambda_0+\lambda_1+\cdots+ \lambda_{n} =1.$ 
