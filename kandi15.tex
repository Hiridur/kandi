...
\end{proof}
\end{lem}
\begin{huom}\label{metrihuom}Lemmoissa  \ref{rajmetri} ja \ref{rajmetri2} hyödynnetään tietoa: $\dfrac{a}{a+1}< \dfrac{b}{b+1}$ jos ja vain jos  $a< b $.
Jos $a< b$ niin $\frac{1}{a}> \frac{1}{b}$ ja edelleen
$$\dfrac{a}{a+1}=\dfrac{a \cdot 1}{a(\frac{1}{a}+1)}=\dfrac{ 1}{\frac{1}{a}+1}< \dfrac{ 1}{\frac{1}{b}+1}=\dfrac{ b\cdot 1}{b(\frac{1}{b}+1)}=\dfrac{b}{b+1}.$$
Toisaalta jos $\dfrac{a}{a+1}< \dfrac{b}{b+1}$ niin
$\dfrac{ 1}{\frac{1}{a}+1}=\dfrac{a}{a+1}<\dfrac{b}{b+1}= \dfrac{ 1}{\frac{1}{b}+1}.$ ja edelleen $a< b$.
